...
int Solver::PerformIK() {
  ...
  while (i < 1000) {
    ...
    // Computing Jacobian Matrix. Constant values for calculation obtained using MATLAB simulation
    J(0, 0) = (14573216048606699*sin(t1))/576460752303423488 -
    (7064328361094851*cos(t1)*sin(t2))/18014398509481984 -
    (7086922019705443*cos(t4)*(cos(t1)*cos(t2)*sin(t3) +
     cos(t1)*cos(t3)*sin(t2)))/144115188075855872 +
     (7086922019705443*sin(t4)*(cos(t1)*sin(t2)*sin(t3)
    ...
    J(0, 1) = (7086922019705443*cos(t4)*(sin(t1)*sin(t2)*sin(t3) -
     cos(t2)*cos(t3)*sin(t1)))/144115188075855872 -
     (7064328361094851*cos(t2)*sin(t1))/18014398509481984 +
     (7086922019705443*sin(t4)*(cos(t2)*sin(t1)*sin(t3) +
    ...
    J(0, 2) = (7086922019705443*cos(t4)*(sin(t1)*sin(t2)*sin(t3) -
     cos(t2)*cos(t3)*sin(t1)))/144115188075855872 + (7086922019705443*sin(t4)*(cos(t2)*sin(t1)*sin(t3) +
     cos(t3)*sin(t1)*sin(t2)))/144115188075855872 + (6567862346812633*sin(t1)*sin(t2)*sin(t3))/144115188075855872 -
     (6567862346812633*cos(t2)*cos(t3)*sin(t1))/144115188075855872;

    J(0, 3) = (7086922019705443*cos(t4)*(sin(t1)*sin(t2)*sin(t3) - cos(t2)*cos(t3)*sin(t1)))/144115188075855872 +
     (7086922019705443*sin(t4)*(cos(t2)*sin(t1)*sin(t3) + cos(t3)*sin(t1)*sin(t2)))/144115188075855872;

    J(1, 0) = (7086922019705443*sin(t4)*(sin(t1)*sin(t2)*sin(t3) - cos(t2)*cos(t3)*sin(t1)))/144115188075855872 -
     (7064328361094851*sin(t1)*sin(t2))/18014398509481984 - (7086922019705443*cos(t4)*(cos(t2)*sin(t1)*sin(t3) +
     cos(t3)*sin(t1)*sin(t2)))/144115188075855872 - (14573216048606699*cos(t1))/576460752303423488 -
     (6567862346812633*cos(t2)*sin(t1)*sin(t3))/144115188075855872 -
     (6567862346812633*cos(t3)*sin(t1)*sin(t2))/144115188075855872;

    J(1, 1) = (7064328361094851*cos(t1)*cos(t2))/18014398509481984 -
     (7086922019705443*cos(t4)*(cos(t1)*sin(t2)*sin(t3) - cos(t1)*cos(t2)*cos(t3)))/144115188075855872 -
    ...
    J(1, 2) = (6567862346812633*cos(t1)*cos(t2)*cos(t3))/144115188075855872 -
     (7086922019705443*sin(t4)*(cos(t1)*cos(t2)*sin(t3) + cos(t1)*cos(t3)*sin(t2)))/144115188075855872 -
     (6567862346812633*cos(t1)*sin(t2)*sin(t3))/144115188075855872 -
     (7086922019705443*cos(t4)*(cos(t1)*sin(t2)*sin(t3) -
     cos(t1)*cos(t2)*cos(t3)))/144115188075855872;

    J(1, 3) = - (7086922019705443*cos(t4)*(cos(t1)*sin(t2)*sin(t3) -
     cos(t1)*cos(t2)*cos(t3)))/144115188075855872 - (7086922019705443*sin(t4)*(cos(t1)*cos(t2)*sin(t3) +
     cos(t1)*cos(t3)*sin(t2)))/144115188075855872;

    J(2, 0) = 0;

    J(2, 1) = - (7064328361094851*sin(t2))/18014398509481984 - (6567862346812633*cos(t2)*sin(t3))/144115188075855872 -
    (6567862346812633*cos(t3)*sin(t2))/144115188075855872 - (7086922019705443*cos(t4)*(cos(t2)*sin(t3) +
    cos(t3)*sin(t2)))/144115188075855872 - (7086922019705443*sin(t4)*(cos(t2)*cos(t3) -
    sin(t2)*sin(t3)))/144115188075855872;

    J(2, 2) = - (6567862346812633*cos(t2)*sin(t3))/144115188075855872 -
     (6567862346812633*cos(t3)*sin(t2))/144115188075855872 -
     (7086922019705443*cos(t4)*(cos(t2)*sin(t3) + cos(t3)*sin(t2)))/144115188075855872 -
     (7086922019705443*sin(t4)*(cos(t2)*cos(t3) - sin(t2)*sin(t3)))/144115188075855872;

    J(2, 3) = - (7086922019705443*cos(t4)*(cos(t2)*sin(t3) +
    cos(t3)*sin(t2)))/144115188075855872 -
    (7086922019705443*sin(t4)*(cos(t2)*cos(t3) - sin(t2)*sin(t3)))/144115188075855872;
  ...
  q_ = Jp * v;
  q += q_;
  std::cout << "Computed joint angles: " << q.transpose() << std::endl;
